...
missionNamespace setVariable ["CTI_CO_CAMP", "Land_Fort_Watchtower_EP1"];//--- Camp classname to be used.
...
missionNamespace setVariable ["CTI_CO_DEPOT", "Land_fortified_nest_big"];//--- Town classname to be used.
