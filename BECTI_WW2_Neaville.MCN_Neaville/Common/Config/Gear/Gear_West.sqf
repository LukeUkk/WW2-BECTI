...
// --- Weapons
// --- GEIST
_i = _i + ["GLIB_FIN_M26"];//GLIB_FIN_5Rnd_762x54mm
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["GLIB_FRA_MAS36"];//GLIB_FRA_5Rnd_75x54mm
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["GLIB_BEL_PISFNGP35"];//GLIB_BEL_13Rnd_9x19mm
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["GLIB_FIN_L35"];//GLIB_FIN_8Rnd_9x19mm //LIB_8Rnd_9x19_P08
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["GLIB_FRA_PA35A"];//GLIB_FRA_8Rnd_765mmLong
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["GLIB_FRA_REV1982"];//GLIB_FRA_6Rnd_827mm
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["GLIB_GBR_ENF2MK1"];//GLIB_GBR_6Rnd_380British
_u = _u	+ [0];
_p = _p	+ [230];
...
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["LIB_M1_Carbine"]; //LIB_15Rnd_762x33
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["LIB_M1A1_Carbine"];//LIB_15Rnd_762x33
_u = _u	+ [0];
_p = _p	+ [230];
_i = _i + ["LIB_DELISLE"];//LIB_7Rnd_45ACP
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1903A3_Springfield"];//LIB_5Rnd_762x63 //LIB_5Rnd_762x63_t
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1903A4_Springfield"];//LIB_5Rnd_762x63
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1918A2_BAR"];//LIB_20Rnd_762x63
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1919A4"];//LIB_50Rnd_762x63
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1919A6"]; //LIB_50Rnd_762x63
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1928_Thompson"]; //LIB_30Rnd_45ACP
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1928A1_Thompson"];  //LIB_30Rnd_45ACP
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1A1_Thompson"]; // LIB_30Rnd_45ACP _t
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M3_GreaseGun"]; //LIB_30Rnd_45ACP _t
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M2_Flamethrower"]; //LIB_M2_Flamethrower_Mag
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M38"]; //LIB_5Rnd_762x54
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M44"]; // LIB_5Rnd_762x54
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M9130"];//LIB_5Rnd_762x54
_u = _u	+ [0];
_p = _p	+ [200];
...
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_FLARE_PISTOL"]; //LIB_1Rnd_flare_white LIB_1Rnd_flare_red","LIB_1Rnd_flare_green"
_u = _u	+ [0];
_p = _p	+ [200];
_i = _i + ["LIB_M1895"]; //LIB_7Rnd_762x38
_u = _u	+ [0];
_p = _p	+ [200];
